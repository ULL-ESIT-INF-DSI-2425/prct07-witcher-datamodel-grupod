...
import { registrarVenta } from "../services/Transacciones.js"; // Importa las funciones para manejar los bienes del inventario
...
async function handleBienes(opcion) {
...
async function handleMercaderes(opcion) {
...
async function handleClientes(opcion) {
...
async function handleTransacciones(opcion) {
